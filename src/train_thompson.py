"""
Training script for the Thompson Sampling bandit.
"""
import numpy as np
import argparse
import weaviate
...
from mab_algorithms import ThompsonSampling
...
# Setup logging
logger = setup_logging("train_thompson")
...
def main(args):
    ...
    try:
        ...
        # --- 4. Run Experiment ---
        # Thompson Sampling doesn't have a hyperparameter in this form
        
        # Create a new RNG for the run
        ...
        run_name = (
            f"ThompsonSampling_lambda={args.lambda_param}_"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Thompson Sampling MAB.")
    parser.add_argument(
        "--lambda_param",
        type=float,
