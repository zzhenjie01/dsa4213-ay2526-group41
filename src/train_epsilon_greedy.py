"""
Training script for the Epsilon-Greedy bandit.
"""
import numpy as np
import argparse
import weaviate
...
from mab_algorithms import EpsilonGreedy
...
# Setup logging
logger = setup_logging("train_epsilon_greedy")
...
def main(args):
    ...
    try:
        ...
        # --- 4. Run Experiments for each Epsilon ---
        for epsilon in args.epsilons:
            ...
            run_name = (
                f"EpsilonGreedy_e={epsilon}_lambda={args.lambda_param}_"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Epsilon-Greedy MAB.")
    parser.add_argument(
        "--epsilons",
        type=float,
        nargs='+',
        default=[0.1],
        help="List of epsilon values to try."
    )
    parser.add_argument(
        "--lambda_param",
        type=float,
